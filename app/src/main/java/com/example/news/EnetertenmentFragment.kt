...
class EnetertenmentFragment : Fragment() {
    ...
    companion object {
        ...
        private lateinit var entertenmentRV: RecyclerView
        var category = "entertainment"
    }
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        // Inflate the layout for this fragment
        val view = inflater.inflate(R.layout.fragment_enetertenment, container, false)

        entertenmentRV = view.findViewById(R.id.entertainmentRV)
        modelClassList = ArrayList()
        entertenmentRV.layoutManager = LinearLayoutManager(context)
        ...
        entertenmentRV.adapter = TrendingFragment.adapter
